...
var anniversary = new Date('Aug 17, 2017 15:00:00');
var next_anniversary = new Date('Aug 17, 2021 15:00:00');
var secondsInADay = 60 * 60 * 1000 * 24;
var secondsInAHour = 60 * 60 * 1000;
var secondsInAMins = 60 * 1000;
var count_up_id = 'countup1';
var count_down_id = 'anniversary';
var count_up_id_times = 'time_only';
...
function get_time(timeDifference) {
  ...
  var minutes = Math.floor(timeDifference % secondsInADay % secondsInAHour / secondsInAMins);
  var seconds = Math.floor(timeDifference % secondsInADay % secondsInAHour % secondsInAMins / 1000);
  return {
    years: years,
    days: days,
    hours: hours,
...
function countUpFromTime(countFrom) {
  ...
  var _get_time = get_time(timeDifference),
      years = _get_time.years,
      days = _get_time.days,
      hours = _get_time.hours,
      minutes = _get_time.minutes,
      seconds = _get_time.seconds;

  var id_times = document.getElementById(count_up_id_times);
  ...
  var idEl = document.getElementById(count_up_id);
...
function countDownToTime(countTo) {
  ...
  if (now > countTo) {
    next_anniversary.setFullYear(next_anniversary.getFullYear() + 1); // countTo.setFullYear(countTo.getFullYear() + 1)
  }

  var _get_time2 = get_time(countTo - now),
      years = _get_time2.years,
      days = _get_time2.days,
      hours = _get_time2.hours,
      minutes = _get_time2.minutes,
      seconds = _get_time2.seconds;

  var idEl = document.getElementById(count_down_id);
  idEl.getElementsByClassName('days')[0].innerHTML = String(days);
  idEl.getElementsByClassName('hours')[0].innerHTML = String(hours);
  idEl.getElementsByClassName('minutes')[0].innerHTML = String(minutes);
  idEl.getElementsByClassName('seconds')[0].innerHTML = String(seconds);
